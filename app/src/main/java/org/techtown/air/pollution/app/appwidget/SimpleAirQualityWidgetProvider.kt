package org.techtown.air.pollution.app.appwidget
...
import org.techtown.air.pollution.app.R
                ...
                .addOnSuccessListener { location ->
                    lifecycleScope.launch {
                        try {
                            ...
                            val updateViews = RemoteViews(packageName, R.layout.widget_simple).apply {
                                setViewVisibility(R.id.labelTextView1, View.VISIBLE)
                                setViewVisibility(R.id.gradeLabelTextView, View.VISIBLE)

                                val currentGrade = (measuredValue?.khaiGrade ?: Gradle.UNKNOWN)
                                setTextViewText(
                                    R.id.resultTextView,
                                    currentGrade.emoji
                                )
